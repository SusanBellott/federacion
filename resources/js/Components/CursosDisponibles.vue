    ...
    <div class="mb-12">
        ...
        >
            ...
            >
                ...
                <div
                    class="w-full p-4 overflow-hidden rounded-t-2xl bg-white/20 flex items-center justify-center"
                >
                    <img
                    ...
                    <div
                        v-else
                        class="w-full h-44 flex items-center justify-center bg-white/10 text-gray-300"
                    >
                        <svg
                            class="w-12 h-12"
                            fill="none"
                ...
                >
                    <div
                        class="space-y-2 text-gray-600 dark:text-gray-400 text-sm"
                    >
                        <h3
                        ...
                        <p
                            class="text-gray-600 dark:text-gray-300 mb-2 text-sm leading-snug"
                        >
                            {{ curso.descripcion }}
                        </p>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span
                                    ...
                                    {{ formatDate(curso.fecha_fin) }}</span
                                >
                            </div>
                            <div class="flex justify-between">
                    ...
                    <div class="mt-6">
                        ...
                        <button
                            ...
                            class="w-full py-3 bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white font-semibold rounded-full shadow-inner transition-colors duration-200 flex items-center justify-center gap-2 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                        >
