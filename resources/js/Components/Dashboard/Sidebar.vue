<template>
    <div>
        ...
        >
            <div class="h-32">
                ...
                >
                    ...
                    />
                    <span
                        class="ml-3 text-xl font-semibold transition-all duration-200 ease-nav-brand"
                        >FDTEULP</span
                    >
                </a>
            </div>
            ...
            <div
                class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full sidebar-no-scrollbar"
            >
                <ul class="flex flex-col pl-0 mb-0">
                    <li
                        v-for="(item, index) in menuItems.filter((item) =>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <i
                                    :class="`relative top-0 text-sm leading-normal ${item.icon}`"
                                ></i>
                            </div>
                            <span
        ...
        <div class="fixed bottom-8 right-8 xl:hidden z-990">
            <button
                @click="toggleSidebar"
                class="p-3 bg-blue-500 rounded-full text-white shadow-lg"
            >
