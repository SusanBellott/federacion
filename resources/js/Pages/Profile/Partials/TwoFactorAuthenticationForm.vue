...
const handleError = (err) => {
    if (err.response?.status === 423) {
        error.value =
            "Please verify your account or confirm your password before enabling 2FA";
    } else {
        error.value =
...
<template>
    <!-- Este codigo se encarga de la autenticacione de 2 factores con una aplicacion movil -->
    <div
        v-if="false"
    ...
    >
        ...
        >
            <div class="flex items-center">
                <p class="mb-0 text-gray-700 dark:text-white dark:opacity-80">
        ...
        <div class="flex-auto p-6">
            <h3
                ...
                class="text-lg font-medium text-slate-700 dark:text-white/80"
            >
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    ...
                    te solicitará un token aleatorio y seguro durante la
                ...
                <div v-if="qrCode">
                    ...
                    >
                        <p v-if="confirming" class="font-semibold">
                            ...
                            aplicación de autenticación de su teléfono o ingrese
                            la clave de configuración y proporcione el código
                            OTP generado.
                        </p>

                        <p v-else>
                            La autenticación de dos factores ya está habilitada.
                            Escanea el siguiente código QR con la aplicación de
            ...
            <div class="mt-5 flex flex-wrap gap-3">
                <div v-if="!twoFactorEnabled">
                    ...
                    >
                        ...
                        <span v-else
                            >Habilitar la autenticación de dos factores</span
                        >
                    </button>
                </div>
