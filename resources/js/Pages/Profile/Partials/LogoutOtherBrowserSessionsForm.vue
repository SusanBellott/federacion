...
const containerClasses = computed(() => {
    return `relative flex flex-col min-w-0 break-words bg-red-600/15 border border-red-600/60 shadow-xl dark:shadow-dark-xl rounded-2xl bg-clip-border`;
});
...
<template>
    <div :class="['mt-12', containerClasses]">
        ...
        <div class="p-6 px-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
            <h6 class="mb-0 text-slate-700 dark:text-white/80">
                Sesiones Activas
            </h6>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Administra y cierra sesión en otros navegadores y dispositivos.
            </p>
        </div>
        ...
        <div class="flex-auto p-4 pt-6">
            <div class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                ...
                recientes se enumeran a continuación. Si crees que tu cuenta ha
                sido comprometida, también deberías cambiar tu contraseña.
            </div>
            ...
            >
                ...
                >
                    <div class="flex items-center w-full">
                        ...
                        <div
                            class="mr-4 text-3xl"
                            :class="getDeviceIcon(session).class"
                        >
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    >
                                        ...
                                        <span
                                            class="text-xs ml-2 px-2 py-1 rounded-full bg-gray-200 dark:bg-gray-700"
                                        >
            ...
            <div class="mt-5">
                ...
                <span
                    ...
                    class="ml-3 text-sm text-green-500"
                >
                    Listo.
                </span>
            </div>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="bg-white dark:bg-slate-850 px-4 pt-5 pb-4 sm:p-6 sm:pb-4"
                >
                    <h3
                        id="modal-title"
                        class="text-lg font-medium text-slate-700 dark:text-white/80 mb-4"
                    >
                        Cerrar Otras Sesiones
                    </h3>
                    <p
                    ...
                    >
                        Por favor ingresa tu contraseña para confirmar que
                        deseas cerrar sesión en tus otros navegadores en todos
                        tus dispositivos.
                    </p>
                ...
                <div
                    class="bg-gray-50 dark:bg-slate-800 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse"
                >
                    <button
