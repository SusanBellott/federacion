<template>
    <div
        class="min-h-screen flex items-center justify-center bg-white px-4 py-8"
    >
        <div
            class="w-full max-w-2xl border p-8 shadow-lg rounded-lg text-center"
        >
            <!-- Logos -->
            ...
            <!-- Título -->
            <h1
                class="text-3xl font-bold text-white bg-red-600 inline-block px-6 py-2 rounded mb-8"
            >
                CERTIFICACIÓN
            </h1>
            <!-- Información -->
            <div class="text-left text-gray-800 space-y-3">
                ...
                <span v-if="inscrito?.user?.complemento_ci"
                    >-{{ inscrito.user.complemento_ci }}</span
                >
                ...
                <p>
                    ...
                    {{ inscrito?.curso?.carga_horaria || "N/A" }}
                </p>
