...
const images = computed(() => {
    ...
    return imagenesData
        .map((imagen) => {
            ...
            const rutaImagen =
                imagen.imagenescer || imagen.ruta || imagen.url || "";
    ...
    <AppLayout title="Instituciones">
        <template #header>
            <div class="p-4 m-4 border-2 border-gray-300 rounded-lg shadow-lg">
                <h2
                    class="font-semibold text-xl text-sky-400 leading-tight text-center"
                >
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <div class="flex-1">
                        ...
                        >
                            <span class="text-sky-500">Nombre del Curso:</span>
                            {{ props.cursos.nombre }}
                        </p>
                    </div>
        ...
        <div class="relative">
            <button
                ...
                @click="atraz"
                aria-label="Cerrar o retroceder"
            >
                &#120143;
            </button>
        </div>
        <div class="p-4 m-4 border-2 border-gray-300 rounded-lg shadow-lg">
            ...
            <div class="p-4 m-4 border-2 border-gray-300 rounded-lg shadow-lg">
                <div
                    v-if="!props.cursos.img_cer"
                    class="carousel-container max-w-full mx-auto"
                >
                    <Carousel
                        v-if="!props.cursos.img_cer"
                        v-bind="config2"
                ...
                <div v-if="props.cursos.img_cer" class="slide-container">
                    ...
                    <div
                        v-for="ima in props.imagenes2"
                        :key="imagenes2.uuid_imgcer"
                    >
                        <img
                            v-if="ima.uuid_imgcer === props.cursos.img_cer"
                            :src="`${baseUrl}/` + ima.imagenescer"
                            class="w-full h-32 object-cover"
                        />
                        <button
                            v-if="ima.uuid_imgcer === props.cursos.img_cer"
                            @click="eliminarimagenbaner(ima.uuid_imgcer)"
                            class="info-button"
                            aria-label="Mostrar información de la imagen"
                        >
                            ❌
            ...
            <div class="w-full max-w-lg mx-auto relative rounded-lg shadow-lg">
                <textarea
                    v-model="props.cursos.titulocer"
                    class="w-full px-4 py-2 border-2 border-sky-700 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 resize-y"
                    rows="2"
                    placeholder="Escribe tu titulo del certificado..."
                ></textarea>
                <!-- Botón para borrar -->
                <button
                    @click="props.cursos.titulocer = ''"
                    class="absolute top-2 right-12 text-gray-500 hover:text-red-500"
                ...
                <button
                    ...
                    class="absolute top-2 right-2 text-gray-500 hover:text-green-500"
            ...
            <div class="w-full max-w-2xl mx-auto relative rounded-lg shadow-lg">
                <textarea
                    v-model="props.cursos.contenidocer"
                    class="w-full px-4 py-2 border-2 border-sky-700 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 resize-y"
                    rows="3"
                    placeholder="Escribe tu contenido del certificado..."
                ></textarea>
                <!-- Botón para borrar -->
                <button
                    @click="props.cursos.contenidocer = ''"
                    class="absolute top-2 right-12 text-gray-500 hover:text-red-500"
                    aria-label="Borrar comentario"
                >
                    🗑️
            ...
            <div class="py-2 carousel-container max-w-xs mx-auto">
                <h1 class="text-sky-400 text-center">
                    SELLO DE LA INSTITUCIÓN
                </h1>
                <div
                    v-if="!props.cursos.img_sello"
                    class="carousel-container max-w-full mx-auto"
                >
                    <Carousel
                        v-if="!props.cursos.img_sello"
                    ...
                    >
                        <Slide v-for="(image, index) in images" :key="image.id">
                            <div class="slide-container">
                                ...
                                />
                                <button
                                    @click="gudarsello1(image.id, index)"
                                    class="info-button"
                                    aria-label="Mostrar información de la imagen"
                                >
                                    ✅
                ...
                <div v-if="props.cursos.img_sello" class="slide-container">
                    ...
                    >
                        <img
                            v-if="ima.uuid_imgcer === props.cursos.img_sello"
                            :src="`${baseUrl}/` + ima.imagenescer"
                        ...
                        <button
                            v-if="ima.uuid_imgcer === props.cursos.img_sello"
                            @click="eliminarsello1(ima.uuid_imgcer)"
                            class="info-button"
                            aria-label="Mostrar información de la imagen"
                        >
                            ❌
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div
                    class="carousel-container w-[300px] mx-auto"
                    v-for="(firma, index) in 4"
                    :key="index"
                >
                    <h1 class="text-sky-400 text-center font-semibold mb-2">
                        FIRMA {{ index + 1 }}
                    </h1>

                    <!-- Mostrar imagen ya seleccionada -->
                    <div
                        v-if="props.cursos[`img_firma${index + 1}`]"
                    ...
                    >
                        ...
                        >
                            <img
                                v-if="
                                    ima.uuid_imgcer ===
                                    props.cursos[`img_firma${index + 1}`]
                                "
                                :src="`${baseUrl}/${ima.imagenescer}`"
                            ...
                            <button
                                ...
                                @click="
                                    eliminarfirma(index + 1, ima.uuid_imgcer)
                                "
                            >
                                &#120143;
                            </button>
                            ...
                            >
                                <div class="slide-container relative">
                                    ...
                                    <button
                                        ...
                                        @click="
                                            gudarfirma(index + 1, image.id, idx)
                                        "
                                    >
                                        ✅
                                    </button>
