    ...
    <AppLayout title="Inscritos">
        ...
        <div class="p-3">
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            getTipoCurso() === "gratuito"
                                                ? "Gratuito"
                                                : `Con costo (Bs. ${getPrecioCurso()})`
                                        }}
                                    </span>
                                    <p
                                        v-if="errors.id_curso"
                                        ...
                                        >
                                            <tbody>
                                                ...
                                                <tr v-else>
                                                    <td
                                                        colspan="2"
                                                        class="text-center text-sm text-gray-500 dark:text-white/70 py-3"
                                                    >
                                                        No hay cursos
            ...
            <ConfirmDelete
                ref="deleteDialog"
                :method="'patch'"
                route-name="editarestadodeleteinscritos.update"
...
const getPrecioCurso = () => {
    const curso = props.cursos?.data?.find(
        (c) => c.id_curso === id_cursof.value
    );
