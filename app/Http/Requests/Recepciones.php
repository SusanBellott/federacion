...
class Recepciones extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_curso' => 'required',
            'ci' => 'required|numeric|digits_between:8,10|unique:users,ci',  // Reglas para 'ci'
            'name' => 'required|regex:/^[\pLÁÉÍÓÚáéíóúÑñ]+$/u|max:30',
            'name2' => 'nullable|regex:/^[\pLÁÉÍÓÚáéíóúÑñ]+$/u|max:30',
            'primer_apellido' => 'required|regex:/^[\pLÁÉÍÓÚáéíóúÑñ]+$/u|max:30',
            'segundo_apellido' => 'required|regex:/^[\pLÁÉÍÓÚáéíóúÑñ]+$/u|max:30',
            'email' => 'required|email|unique:users,email',
            'rda' => 'required|numeric|digits_between:1,10|unique:users,rda',
            'item' => 'required|integer|min:1|max:99993',
            'cargo' => 'required|integer|min:20|max:9082',
            'horas' => 'required|integer|min:8|max:144',
    ...
    public function messages()
    {
        return [
            ...
            'ci.digits_between' => 'El CI debe tener entre 8 y 10 dígitos.',
            ...
            'rda.digits' => 'El RDA debe tener exactamente 10 dígitos.',
            ...
            'horas.max' => 'Las horas no pueden superar 144.',
