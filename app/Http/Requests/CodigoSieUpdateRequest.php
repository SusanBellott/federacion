...
class CodigoSieUpdateRequest extends FormRequest
{
    ...
    {
        $codigo = CodigoSie::where('uuid_codigo_sie', $this->route('codigo_sie'))->first();
        ...
        return [
            ...
            'programa' => [
                ...
                'numeric',
                'between:11,80730947',
                Rule::unique('codigo_sies', 'programa')->ignore($codigo?->id_codigo_sie),
            ],
            'unidad_educativa' => [
                'required',
                'string',
