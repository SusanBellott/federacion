<?php
/// REPORTE MENSUAL DE CURSOS REALIZADOS YA ESTA TESTEAODO NO EDITAR MAS.........
namespace App\Pdf;

use Codedge\Fpdf\Fpdf\Fpdf;

class EncabezadoMensual extends Fpdf
{
    public $tituloReporte = 'REPORTE MENSUAL DE CURSOS';
    public $fechaHora;
